                    ...
                    <div className="single-w3pvt-page mt-md-5 mt-4 px-lg-5">
                        ...
                        <div className="comment-sec-w3ls">
                            ...
                            <ul className="list-unstyled">
                                <li className="media">
                                    <img className="mr-3 img-fluid" src="assets/images/sb1.jpg" alt=""/>
                                ...
                                <li className="media my-5 ml-3">
                                    <img className="mr-3 img-fluid" src="assets/images/sb2.jpg" alt=""/>
                                    <div className="media-body">
                                ...
                                <li className="media ml-5">
                                    <img className="mr-3 img-fluid" src="assets/images/sb3.jpg" alt=""/>
                                    <div className="media-body">
